    ...
    <div className="h-full flex flex-col bg-primary-800">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-4">
        ...
        <div className="text-center py-2">
          ...
          <h3 className="text-xl font-bold text-primary-100">Upcycling Complete!</h3>
          <p className="text-primary-100 text-sm mt-1">Here is the AI-generated upcycling preview</p>
        </div>
        ...
        <div className="bg-primary-100 rounded-3xl overflow-hidden border border-primary-200">
          ...
          <div className={`relative overflow-hidden ${templateId === 'bag' ? 'aspect-[2/3]' : 'h-64'}`}>
            {showBefore ? (
              uploadedImage ? (
                ...
                <div className="w-full h-full bg-primary-200 flex items-center justify-center text-6xl">👗</div>
              )
            ) : (
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            <div>
              <p className="font-semibold text-primary-900 text-sm">{template.name}</p>
              <p className="text-[11px] text-primary-600 mt-0.5">Transformed from your old clothing</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] text-primary-500">Carbon Emissions Reduced</p>
          ...
          <div className="flex justify-around">
            {[
              ...
              <div key={stat.label} className="text-center">
                <p className="text-lg font-bold text-primary-100">{stat.value}</p>
                <p className="text-primary-200 text-[10px] mt-0.5">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
