...
const translations = {
  en: {
    ...
    closet: {
      ...
      emptyHint: "Add your first fabric to get started",
      addFabric: "Add Fabric",
      formTitle: "Add Fabric",
      labelName: "Name",
      labelSourceType: "Source",
      labelColor: "Colour",
      labelFiberContent: "Fibre Content",
      labelLengthCm: "Length (cm)",
      labelWidthCm: "Width (cm)",
      labelNotes: "Notes",
      labelImageUrl: "Image URL (optional)",
      sourceThrifted: "Thrifted",
      sourceDestash: "Destash",
      sourceNew: "New",
      sourceOwned: "Owned",
      save: "Save",
      cancel: "Cancel",
  ...
  nb: {
    ...
    closet: {
      title: "Min garderobe",
      fabrics: "Stoffer",
      emptyTitle: "Ingen stoffer ennå",
      emptyHint: "Legg til ditt første stoff for å komme i gang",
      addFabric: "Legg til stoff",
      formTitle: "Legg til stoff",
      labelName: "Navn",
      labelSourceType: "Kilde",
      labelColor: "Farge",
      labelFiberContent: "Fiberinnhold",
      labelLengthCm: "Lengde (cm)",
      labelWidthCm: "Bredde (cm)",
      labelNotes: "Notater",
      labelImageUrl: "Bilde-URL (valgfritt)",
      sourceThrifted: "Brukthandel",
      sourceDestash: "Destash",
      sourceNew: "Ny",
      sourceOwned: "Eget lager",
      save: "Lagre",
      cancel: "Avbryt",
      delete: "Slett",
      loading: "Laster stoffer\u2026",
    ...
    analysis: {
      ...
      saveToCloset: "Legg til i klesskapet",
      savedToCloset: "Lagt til i klesskapet ✓",
    },
    templateSelect: {
  ...
  zh: {
    ...
    closet: {
      ...
      fabrics: "布料",
      emptyTitle: "尚無布料",
      emptyHint: "新增第一塊布料開始使用",
      addFabric: "新增布料",
      formTitle: "新增布料",
      labelName: "名稱",
      labelSourceType: "來源",
      labelColor: "顏色",
      labelFiberContent: "纖維成分",
      labelLengthCm: "長度（公分）",
      labelWidthCm: "寬度（公分）",
      labelNotes: "備注",
      labelImageUrl: "圖片網址（選填）",
      sourceThrifted: "二手店",
      sourceDestash: "清倉",
      sourceNew: "新品",
      sourceOwned: "自有",
