export const templates = {
  bag: {
    ...
    patternPieces: [
      ...
      { id: 'body-1',  label: 'Body Panel 1', widthCm: 20, heightCm: 15,
        shape: 'rect', color: '#fbbf24', grainAngleDeg: 90, defaultX: 30, defaultY: 15 },
      { id: 'side',    label: 'Side Panel',   widthCm: 15, heightCm: 5,
        shape: 'rect', color: '#fb923c', grainAngleDeg: 90, defaultX: 35, defaultY: 32 },
      // BACK shirt (body y≈350–490px)
      { id: 'body-2',  label: 'Body Panel 2', widthCm: 20, heightCm: 15,
        shape: 'rect', color: '#f59e0b', grainAngleDeg: 90, defaultX: 30, defaultY: 67 },
      { id: 'strip-1', label: 'Strip 1',      widthCm: 20, heightCm: 5,
        shape: 'rect', color: '#f97316', grainAngleDeg: 90, defaultX: 9,  defaultY: 84 },
      { id: 'strip-2', label: 'Strip 2',      widthCm: 20, heightCm: 5,
        shape: 'rect', color: '#ea580c', grainAngleDeg: 90, defaultX: 51, defaultY: 84 },
    ],
    materials: [
  ...
  hat: {
    ...
    patternPieces: [
      { id: 'panel-1', label: 'Crown Panel 1', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#38bdf8', grainAngleDeg: 90, defaultX: 3, defaultY: 3 },
      { id: 'panel-2', label: 'Crown Panel 2', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#38bdf8', grainAngleDeg: 90, defaultX: 3, defaultY: 28 },
      { id: 'panel-3', label: 'Crown Panel 3', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#38bdf8', grainAngleDeg: 90, defaultX: 3, defaultY: 53 },
      { id: 'panel-4', label: 'Crown Panel 4', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#0ea5e9', grainAngleDeg: 90, defaultX: 40, defaultY: 3 },
      { id: 'panel-5', label: 'Crown Panel 5', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#0ea5e9', grainAngleDeg: 90, defaultX: 40, defaultY: 28 },
      { id: 'panel-6', label: 'Crown Panel 6', widthCm: 12, heightCm: 14,
        shape: 'trapezoid', topWidthCm: 8, bottomWidthCm: 12,
        color: '#0ea5e9', grainAngleDeg: 90, defaultX: 40, defaultY: 53 },
      { id: 'crown-top', label: 'Crown Top', widthCm: 14, heightCm: 14,
        shape: 'circle', color: '#7dd3fc', grainAngleDeg: 0, defaultX: 68, defaultY: 3 },
      { id: 'brim', label: 'Brim', widthCm: 30, heightCm: 30,
        shape: 'ring', outerRadiusCm: 15, innerRadiusCm: 9,
        color: '#bae6fd', grainAngleDeg: 0, defaultX: 30, defaultY: 65 },
    ],
    materials: [
      'Old garment (main fabric)',
      'Matching thread',
