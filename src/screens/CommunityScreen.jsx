...
const posts = [
  ...
  { id: 2, user: 'Jason', avatar: '👨‍🦱', item: 'Vintage Bucket Hat',   emoji: '🧢', bg: 'from-orange-100 to-amber-50',   likes: 89,  comments: 12, tag: 'Bucket Hat' },
  { id: 3, user: 'Lily',  avatar: '👩‍🦳', item: 'Plaid Shopping Bag',   emoji: '🛍', bg: 'from-lime-100 to-green-50',     likes: 234, comments: 31, tag: 'Shopping Bag' },
  { id: 4, user: 'Jake',  avatar: '🧑',   item: 'Denim Bucket Hat',     emoji: '🧢', bg: 'from-stone-100 to-orange-50',   likes: 67,  comments: 8,  tag: 'Bucket Hat',  image: '/hat-result.png' },
  { id: 5, user: 'Emily', avatar: '👩',   item: 'Floral Tote Bag',      emoji: '👜', bg: 'from-secondary-100 to-amber-50', likes: 189, comments: 25, tag: 'Tote Bag' },
  { id: 6, user: 'Wang',  avatar: '👴',   item: 'Plaid Tote Bag',       emoji: '👜', bg: 'from-stone-200 to-stone-100',   likes: 45,  comments: 6,  tag: 'Tote Bag' },
  { id: 7, user: 'Amy',   avatar: '👩‍🦱', item: 'Denim Bucket Hat',     emoji: '🧢', bg: 'from-primary-100 to-primary-50', likes: 112, comments: 14, tag: 'Bucket Hat' },
  { id: 8, user: 'Jian',  avatar: '🧑‍🦲', item: 'Striped Shopping Bag', emoji: '🛍', bg: 'from-amber-100 to-secondary-50', likes: 78, comments: 9,  tag: 'Shopping Bag' },
]
    ...
    <div className="h-full flex flex-col bg-primary-800">
      ...
      <div className="px-5 pt-8 pb-3">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-bold text-primary-100">Community Works</h2>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-2">
        {tab === 'following' ? (
          <div className="flex flex-col items-center justify-center h-48 text-center">
            ...
            <p className="text-primary-300 text-sm font-medium">No users followed yet</p>
            <p className="text-primary-500 text-xs mt-1">Go to Featured to discover works you like</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className={`h-36 relative overflow-hidden ${!post.image ? `bg-gradient-to-br ${post.bg} flex items-center justify-center` : ''}`}>
                  ...
                  <div className="absolute top-2 right-2 bg-primary-900/60 backdrop-blur-sm rounded-full px-2 py-0.5">
                    <span className="text-[10px] text-primary-200 font-medium">#{post.tag}</span>
                  </div>
                </div>
                {/* Info */}
                <div className="p-3">
                  <p className="font-semibold text-primary-900 text-xs truncate mb-1.5">{post.item}</p>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5">
                      <span className="text-sm">{post.avatar}</span>
                      <span className="text-[11px] text-primary-500">{post.user}</span>
                    </div>
                    <button
